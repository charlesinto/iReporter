...
import {newRecord,newRecord1, location, createuser, user, token, update} from '../model';
...
describe('It should test all the end points', () => {
   ...
   describe('it should patch a intervention records location',() => {
        ...
        it('response should have a status of 201',(done)=>{
            chai.request(app).patch('/api/v1/interventions/3401/location').type('form').set('authorization',token).set('content-type', 'application/json')
            .send(location).end((err,res) => {
